"""
Created on Wed May 21 17:58:54 2025

@author: maximekalardashti
"""

# BACKTEST STRATEGIE MARKOWITZ AVEC CONTRAINTES DE DIVERSIFICATION
...
def optimize_portfolio(mu, cov, risk_free_rate):
    ...
    bounds = [(0.05, 0.4)] * len(mu)  # Minimum 5%, maximum 40% par actif
...
df_results.plot(title="Stratégie Markowitz avec contraintes vs S&P 500", grid=True)
